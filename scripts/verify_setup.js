...
// 1. Check all tables
const tables = ['profiles', 'news', 'timetable', 'case_decks', 'case_submissions', 
  'guestimate_submissions', 'user_activity', 'user_statistics', 'case_rankings',
  'activity_heatmap', 'events', 'deadlines', 'competitions', 'practice_questions',
  'leaderboard_points', 'alumni', 'timetable_alerts'];
