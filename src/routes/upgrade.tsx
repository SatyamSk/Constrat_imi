...
export const Route = createFileRoute("/upgrade")({ component: BecomePro });
      ...
      <section className="mx-auto max-w-[1180px] px-5 md:px-6 py-16">
        ...
        <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Feature
            ...
            body="Snap your handwritten case structure, get an AI-scored breakdown in seconds. Free plan stops at 5/day — Pro keeps going as long as you do."
          />
          <Feature
            icon="📰"
