...
export const Route = createFileRoute("/news")({
  ...
  head: () => ({
    meta: [
      { title: "Business News — Constrat" },
      { name: "description", content: "Curated, AI-summarized business news for B-school interviews and GDs." },
      { property: "og:title", content: "Business News — Constrat" },
      { property: "og:description", content: "Everything you need to know before your interview." },
    ],
  }),
});
...
const NEWS = [
  { src: "Reuters", topic: "Markets & Economy", title: "RBI holds repo rate at 6.5%, signals cautious stance on inflation.", time: "2 hours ago", read: "2 min", sum: ["MPC unchanged 5–1; food inflation flagged.", "Bond yields unchanged; INR steady at 83.4.", "Watch: stance shift expected by Q3."] },
  { src: "Economic Times", topic: "Startups & VC", title: "Zepto closes $665M round, valuation crosses $5B.", time: "3 hours ago", read: "3 min", sum: ["Existing investors led; pre-IPO positioning.", "Quick-commerce GMV race intensifies.", "Profitability path remains the open question."] },
  { src: "Bloomberg", topic: "Global Business", title: "Apple shifts ~25% of iPhone production to India by 2026.", time: "5 hours ago", read: "4 min", sum: ["Foxconn + Tata as anchor partners.", "Geo-diversification away from China accelerates.", "PLI scheme cited as decisive."] },
  { src: "Financial Times", topic: "Consulting Industry", title: "McKinsey to cut ~3% of senior consultants amid demand softening.", time: "Yesterday", read: "3 min", sum: ["Tech and FS practices most affected.", "AI-led delivery models reshape staffing.", "Hiring at junior levels stays steady."] },
  { src: "Mint", topic: "FMCG & Retail", title: "HUL reports flat volume growth, premium portfolio outpaces.", time: "Yesterday", read: "2 min", sum: ["Premium portfolio +8% YoY.", "Rural demand recovery still patchy.", "Pricing actions paused for Q2."] },
  { src: "Economic Times", topic: "Policy & Regulation", title: "Centre tightens UPI MDR debate; banks push back.", time: "2 days ago", read: "3 min", sum: ["Zero-MDR cost burden in spotlight.", "Banks seek calibrated revenue model.", "Final policy view expected by Q3."] },
];
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle="Pulled from RSS feeds. Filtered for relevance. AI-summarized for speed."
      >
        ...
        <div className="mx-auto max-w-[1180px] px-6 py-12">
          ...
          <article className="card-base overflow-hidden grid md:grid-cols-[1.4fr_1fr]">
            <div className="p-8">
              ...
              <p className="mt-3 text-[16px] text-text-secondary">Reuters · 2 hours ago</p>
              <div className="mt-6">
                <span className="label-orange">AI Summary</span>
                <ul className="mt-3 space-y-2 text-[14px] text-text-secondary">
                  <li>· MPC unchanged 5–1, with food inflation flagged as the dominant risk.</li>
                  <li>· Bond yields unchanged; INR steady at 83.4 to USD.</li>
                  <li>· Watch: stance shift expected by Q3, conditional on monsoon and food prices.</li>
                </ul>
              </div>
              <button className="btn-primary mt-7">Read full story →</button>
            </div>
            <div
          ...
          <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((n, i) => (
              <article key={i} className="card-base p-6 relative">
                <button className="absolute top-4 right-4 text-[14px] text-text-muted hover:text-orange">☆</button>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button className="btn-ghost text-[13px]">Read →</button>
                </div>
              </article>
            ))}
          </div>
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={g.t} className="card-base p-6">
                ...
                <button className="btn-ghost text-[13px] mt-5">Practice this GD →</button>
              </div>
            ))}
          </div>
        </div>
