...
export function PageHeader({
  ...
  return (
    <section className={`border-b border-border ${alt ? "bg-section-alt" : "bg-surface"}`}>
      <div className="mx-auto max-w-[1180px] px-5 md:px-6 py-16 md:py-20">
        ...
        {subtitle && (
          <p className="mt-5 text-[16px] md:text-[17px] text-text-secondary max-w-[640px] leading-[1.65]">
            {subtitle}
          </p>
        )}
